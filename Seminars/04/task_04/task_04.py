...
def create_polynomial(k: int) -> str:
    try:
        #Создаём список коэффициентов многочленов
    ...
    #невозможности сборки многочлена с такими коэффициентами
        ...
        print("\033[6m\033[31m{}\033[0m".format("Многочлен с такими коэффициентами или степенью не возможен"))
        return None
...
print(f"Многочлен с максимальной степенью {k} и случайными целыми коэффициентами в промежутке [-10;10]: \n{polynom}")
